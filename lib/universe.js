(function() {
  ...
  module.exports = Universe = (function() {
    ...
    Universe.prototype.enableControls = function() {
      this.board.addEventListener("touchstart", __bind(function(e) {
      ...
      this.board.addEventListener("touchmove", __bind(function(e) {
      ...
      this.board.addEventListener("touchend", __bind(function(e) {
