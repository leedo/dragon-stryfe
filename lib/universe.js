(function() {
  ...
  module.exports = Universe = (function() {
    function Universe(starting_name, colors) {
      this.self;
      this.players = {};
      this.powerups = [];
      this.tick_count = 0;
    ...
    Universe.prototype.gameTick = function() {
      ...
      this.drawOverlay();
      this.drawPowerups();
      if (this.tick_count % constants.syncTimer === 0) {
        this.syncSelf();
      }
    ...
    Universe.prototype.tickPlayer = function(player) {
      ...
      if (player !== this.self) {
        return player.drawName(this.context);
      }
    };
    ...
    Universe.prototype.drawHealthMeter = function() {
      var width, x, y, _ref;
      _ref = [10, 10], x = _ref[0], y = _ref[1];
      this.context.fillStyle = "rgba(255,255,255,0.2)";
      this.context.fillRect(x, y, 100, 5);
      this.context.fillStyle = "red";
      width = 100 - (this.self.damage / constants.deadlyDamage);
      return this.context.fillRect(x, y, width, 5);
    };
