(function() {
  ...
  module.exports = Universe = (function() {
    ...
    Universe.prototype.drawOverlay = function() {
      ...
      this.context.fillRect(5, 5, 120, 47);
      this.context.font = "9px sans-serif";
      util.drawOutlinedText(this.context, this.self.name, 10, 15);
    ...
    Universe.prototype.drawPlayerList = function() {
      ...
      this.context.fillStyle = "rgba(0,0,0,0.5)";
      this.context.fillRect(x - 5, y - 15, 100, 100);
    ...
    Universe.prototype.drawEnergyMeter = function() {
      ...
      this.context.fillRect(x, y, 110, 11);
      this.context.fillStyle = "yellow";
      width = 110 * (this.self.energy / constants.maxEnergy);
      this.context.fillRect(x, y, width, 11);
      this.context.font = "9px sans-serif";
      return util.drawOutlinedText(this.context, "ENERGY", x + 2, y + 9);
    };
    Universe.prototype.drawHealthMeter = function() {
      var percent, x, y, _ref;
      _ref = [10, 20], x = _ref[0], y = _ref[1];
      this.context.fillStyle = "rgba(255,255,255,0.2)";
      this.context.fillRect(x, y, 110, 11);
      percent = this.self.hpPercent();
      this.context.fillStyle = percent > .2 ? "green" : "red";
      this.context.fillRect(x, y, percent * 110, 11);
      this.context.font = "9px sans-serif";
      return util.drawOutlinedText(this.context, "HEALTH", x + 2, y + 9);
    };
