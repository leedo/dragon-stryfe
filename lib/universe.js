(function() {
  ...
  Universe = (function() {
    ...
    Universe.prototype.gameTick = function() {
      var attacker, id, id1, id2, player, target, _ref, _ref2, _ref3, _ref4;
      ...
      for (id1 in _ref2) {
        ...
        attacker.tryToBreathe(attacker, this.self);
        _ref3 = this.players;
        for (id2 in _ref3) {
          target = _ref3[id2];
    ...
    Universe.prototype.initSelf = function(state) {
      ...
      this.self = players.createSelf(state);
    ...
    Universe.prototype.drawPlayer = function(player) {
      ...
      if (player.breathing) {
        ...
        this.context.moveTo(4, 8);
        this.context.lineTo(12, -40);
        this.context.lineTo(-4, -40);
        this.context.fill();
      }
