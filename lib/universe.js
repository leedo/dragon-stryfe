(function() {
  ...
  Universe = (function() {
    ...
    Universe.prototype.drawStats = function() {
      ...
      return this.context.fillText("id: " + this.self.id, 10, 60);
    };
    ...
    Universe.prototype.tickPlayer = function(player) {
      var flip, id, target, _ref;
      flip = player.position.x <= 0 || player.position.x >= this.board.width || player.position.y >= this.board.height || player.position.y <= 0;
      if (flip) {
