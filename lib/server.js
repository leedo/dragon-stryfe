(function() {
  var OAuth, app, broadcast, constants, express, fs, game, io, next_id, object_id, package, redis, redis_client, send, send_powerup, socket, stitch, util;
  ...
  send_powerup = function() {
    ...
    return setTimeout(send_powerup, Math.random() * 5000);
  };
  send_powerup();
