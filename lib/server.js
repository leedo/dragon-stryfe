(function() {
  ...
  app.get("/game", function(req, res) {
    return res.sendfile("templates/game.html");
  });
  app.get("/login", function(req, res) {
    return res.sendfile("templates/login.html");
  });
  app.get("/twitter_login", function(req, res) {
    ...
    return oa.getOAuthRequestToken(function(error, token, token_secret, results) {
      if (error) {
        ...
        return res.redirect("https://api.twitter.com/oauth/authorize?oauth_token=" + token);
      }
    });
  });
