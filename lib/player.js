(function() {
  var Animation, ControlState, Player, PositionState, breath, constants, screech, util;
  ...
  module.exports = Player = (function() {
    ...
    Player.prototype.updatePosition = function() {
      ...
      this.x -= velocity_x;
      this.x = Math.min(constants.universeWidth, Math.max(this.x, 0));
      this.y -= velocity_y;
      return this.y = Math.min(constants.universeHeight, Math.max(this.y, 0));
    };
